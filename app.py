...
line_bot_api = LineBotApi(os.environ.get('LINECHANNELACCESSTOKEN'))#YOUR_CHANNEL_ACCESS_TOKEN
handler = WebhookHandler(os.environ.get('LINECHANNELSECRET'))#YOUR_CHANNEL_SECRET
